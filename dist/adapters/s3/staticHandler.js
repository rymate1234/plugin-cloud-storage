        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    object_1 = _a.sent();
                    res.set({
                        'Content-Length': object_1.ContentLength,
                        'Content-Type': object_1.ContentType,
                        ETag: object_1.ETag,
                    });
                    if (object_1 === null || object_1 === void 0 ? void 0 : object_1.Body) {
                        return [2 /*return*/, object_1.Body
                                .pipe(res)
